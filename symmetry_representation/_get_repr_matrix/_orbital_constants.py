...
WANNIER_ORBITALS = {
    ...
    # ],
    # 'sp': ['1 + x', '1 - x'],
    # 'sp2': ['1 / sqrt(3) - x / sqrt(6) + y / sqrt(2)', '1 / sqrt(3) - x / sqrt(6) - y / sqrt(2)', '1 / sqrt(3) + 2 * x / sqrt(6)'],
    'sp3':
    ['1 + x + y + z', '1 + x - y  - z', '1 - x + y - z', '1 - x - y + z'],
    # 'sp3d': ['1 / sqrt(3) - x / sqrt(6) + y / sqrt(2)', '1 / sqrt(3) - x / sqrt(6) - y / sqrt(2)', '1 / sqrt(3) + 2 * x / sqrt(6)', 'z / sqrt(2) + z**2 / sqrt(2)', '-z / sqrt(2) + z**2 / sqrt(2)'],
}
